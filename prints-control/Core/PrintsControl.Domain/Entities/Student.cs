...
public class Student : BaseEntity
{
    ...
    public Student(Guid studentId, string name, int balance)
    {
    ...
    public void BuyPackage(int quantity)
    {
        ...
        Balance += quantity;
        _purchases.Add(new Purchase(StudentId, quantity));
    }

    public override string ToString()
    {
        return $"Código: {Id} |  Estudante: {Name} | Saldo de impressões: {Balance}";
    }
}